...
for (d in 1:D){
  ...
  EmpiricalMSEpropPRE.ART<-mean((propfinMC.Art[d,]-propMC[d,])^2)
  EmpiricalMSEgapPre.ART<-mean((gapfinMC.Art[d,]-gapMC[d,])^2)
  EmpiricalMSEpropPre.New<-mean((propfinMC.New[d,]-propMC[d,])^2)
  EmpiricalMSEgapPre.New<-mean((gapfinMC.New[d,]-gapMC[d,])^2)
}
